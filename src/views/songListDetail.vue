    ...
    <div class="songListDetail">
        ...
        <div class="container" ref="container" v-on:scroll="scrollFunc">
            <div class="intoContainer" ref="intoContainer">
                ...
                <h4 class="title">{{listBaseInfo.title}}{{listBaseInfo.title}}{{listBaseInfo.title}}{{listBaseInfo.title}}</h4>
                <div class="author">
            ...
            .cover {
                ...
                .playCount {
                    ...
                    &:before {
                        ...
                        left: 0;
                        top: 50%;
                        transform: translate(rem(-23 / 2), -50%);
                        width: rem(17 / 2);
                        height: rem(21 / 2);
